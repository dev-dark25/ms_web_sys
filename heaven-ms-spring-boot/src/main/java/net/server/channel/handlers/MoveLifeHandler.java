    ...
    public final void handlePacket(SeekableLittleEndianAccessor slea, MapleClient c) {
        ...
        try {
            ...
            if (GameEnums.DebugLevel.isFull()) {
                System.out.println((isSkill ? "技能 " : (isAttack ? "普攻 " : " ")) + "castPos: " + castPos + " rawAct: " + rawActivity + " opt: " + pOption + " 技能id: " + useSkillId + " 技能等级: " + useSkillLevel + " " + "是否允许技能: " + nextMovementCouldBeSkill + " 怪物蓝量: " + mobMp);
            }
        ...
        } catch (EmptyMovementException ignore) {
        }
