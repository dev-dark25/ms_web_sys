                ...
                if (mode == 6) { //additem
                    ...
                    if (marriage != null) {
                        try {
                            ...
                            if (giftCount < CommonConfig.config.server.weddingGiftLimit) {
                                ...
                                if (chr.getId() != cid) {   // cannot gift yourself
                                    ...
                                    if (spouse != null) {
                                        ...
                                        if (newItem != null) {
                                            if (CommonConfig.config.server.useEnforceMerchantSave) chr.saveCharToDB(false);
                        ...
                        if (groomWishlist != null) {
                            ...
                            if (item != null) {
                                if (MapleInventory.checkSpot(chr, item)) {
                                    ...
                                    c.getPlayer().dropMessage(1, "在收集该物品之前，请在您的背包中空出一个位置。");
                                ...
                                c.getPlayer().dropMessage(1, "您已经收集了该物品。");
                                c.announce(Wedding.OnWeddingGiftResult((byte) 0xE, marriage.getWishlistItems(groomWishlist), marriage.getGiftItems(c, groomWishlist)));
                            }
                        }
                    } else {
