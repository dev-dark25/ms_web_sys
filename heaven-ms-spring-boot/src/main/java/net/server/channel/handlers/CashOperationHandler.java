                ...
                if (action == 0x03 || action == 0x1E) {
                    ...
                    if (action == 0x03) { // Item
                        if (ItemConstants.isCashStore(cItem.getItemId()) && chr.getLevel() < 16) {
                            c.enableCSActions();
                            return;
                        } else if (ItemConstants.isRateCoupon(cItem.getItemId()) && !CommonConfig.config.server.useSupplyRateCoupons) {
                    ...
                    if(cItem.getSn() == 50600000 && CommonConfig.config.server.allowCashShopNameChange) {
                    ...
                    if(cItem.getSn() == 50600001 && CommonConfig.config.server.allowCashShopWorldTransfer) {
