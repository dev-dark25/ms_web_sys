...
public final class OpenFamilyPedigreeHandler extends AbstractMaplePacketHandler {
    ...
    public final void handlePacket(SeekableLittleEndianAccessor slea, MapleClient c) {
        if(!CommonConfig.config.server.useFamilySystem) return;
        MapleCharacter target = c.getChannelServer().getPlayerStorage().getCharacterByName(slea.readMapleGbkString());
