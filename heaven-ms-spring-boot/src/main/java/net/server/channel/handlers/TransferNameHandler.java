...
public final class TransferNameHandler extends AbstractMaplePacketHandler {
    ...
    public final void handlePacket(SeekableLittleEndianAccessor slea, MapleClient c) {
        ...
        if(!CommonConfig.config.server.allowCashShopNameChange) {
        ...
        try (Connection con = MysqlConnection.getConnection();
            ...
            while(rs.next()) {
                ...
                if(completedTimestamp == null) { //has pending name request
                    ...
                    return;
                } else if(completedTimestamp.getTime() + CommonConfig.config.server.nameChangeCoolDown > System.currentTimeMillis()) {
