            ...
            if(accept) {
                if(inviter.getFamily() != null) {
                    if(chr.getFamily() == null) {
                        ...
                        if(inviter.getFamily().getTotalGenerations() + targetFamily.getTotalGenerations() <= CommonConfig.config.server.familyMaxGenerations) {
                    ...
                    if(chr.getFamily() != null && inviter.getFamily() != null && chr.getFamily().getTotalGenerations() + inviter.getFamily().getTotalGenerations() >= CommonConfig.config.server.familyMaxGenerations) {
                        inviter.announce(MaplePacketCreator.sendFamilyMessage(76, 0));
                        chr.announce(MaplePacketCreator.sendFamilyMessage(76, 0));
                        return;
                    }
