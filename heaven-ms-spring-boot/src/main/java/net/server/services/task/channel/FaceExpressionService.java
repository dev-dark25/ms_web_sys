...
public class FaceExpressionService extends BaseService {
    ...
    private FaceExpressionScheduler faceExpressionSchedulers[] = new FaceExpressionScheduler[CommonConfig.config.server.channelLocks];
    private MonitoredReentrantLock faceLock[] = new MonitoredReentrantLock[CommonConfig.config.server.channelLocks];
