...
public class MobStatusService extends BaseService {
    ...
    private MobStatusScheduler mobStatusSchedulers[] = new MobStatusScheduler[CommonConfig.config.server.channelLocks];
    ...
    private class MobStatusScheduler extends BaseScheduler {
        ...
        private class MobStatusOvertimeEntry {
            ...
            protected MobStatusOvertimeEntry(int delay, Runnable run) {
                procCount = 0;
                procLimit = (int)Math.ceil((float) delay / CommonConfig.config.server.mobStatusMonitorProc);
                r = run;
            }
