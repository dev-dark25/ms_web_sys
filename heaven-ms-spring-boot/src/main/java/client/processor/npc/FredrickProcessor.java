...
public class FredrickProcessor {
    ...
    private static String fredrickReminderMessage(int daynotes) {
        ...
        if (daynotes < 4) {
            msg = " 你好，尊敬的玩家！我是Hired Merchant Union的工会主席Fredrick。提醒您，自您使用我们的服务以来已经过去了 " + dailyReminders[daynotes] + " 天。请在自由市场入口处索取您存储的物品。";
        } else {
            msg = "你好，尊敬的玩家！我是Hired Merchant Union的工会主席Fredrick。自您使用我们的服务以来已经过去了 " + dailyReminders[daynotes] + " 天。请考虑在我们将物品移开以供退还之前索取它们。";
        }
