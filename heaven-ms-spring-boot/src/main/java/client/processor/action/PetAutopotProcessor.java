        ...
        public void run() {
            ...
            try {
                ...
                if (toUse != null) {
                    ...
                    if (CommonConfig.config.server.useCompulsoryAutoPot) {
                        if (hasHpGain) {
                            double hpRatio = (CommonConfig.config.server.petAutoHpRatio * maxHp) - curHp;
                            if (hpRatio > 0.0) {
                        ...
                        if (hasMpGain) {
                            double mpRatio = ((CommonConfig.config.server.petAutoMpRatio * maxMp) - curMp);
                            if (mpRatio > 0.0) {
