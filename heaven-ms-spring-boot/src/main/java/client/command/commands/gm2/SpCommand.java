...
public class SpCommand extends Command {
    ...
    public void execute(MapleClient c, String[] params) {
        ...
        if (params.length < 1) {
            player.yellowMessage("语法：!sp [<角色ID>] <SP点>");
            return;
        }
        ...
        if (params.length == 1) {
            ...
            if (newSp < 0) newSp = 0;
            else if (newSp > CommonConfig.config.server.maxAp) newSp = CommonConfig.config.server.maxAp;
            ...
            if (victim != null) {
                ...
                player.dropMessage(5, "给与玩家'"+params[0]+"' "+newSp+"' 点技能点");
            } else {
