...
public class EventManager {
    ...
    public long getLobbyDelay() {
        return CommonConfig.config.server.eventLobbyDelay;
    }
    ...
    public void disposeInstance(final String name) {
        ...
        }, CommonConfig.config.server.eventLobbyDelay * 1000);
    }
    ...
    public boolean isQueueFull() {
        synchronized(queuedGuilds) {
            return queuedGuilds.size() >= CommonConfig.config.server.eventMaxGuildQueue;
        }
    }
