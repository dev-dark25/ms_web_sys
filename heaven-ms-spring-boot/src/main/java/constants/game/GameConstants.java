...
public class GameConstants {
    public static String[] WORLD_NAMES = {"1区", "Bera", "Broa", "Windia", "Khaini", "Bellocan", "Mardia", "Kradia", "Yellonde", "Demethos", "Galicia", "El Nido", "Zenith", "Arcenia", "Kastia", "Judis", "Plana", "Kalluna", "Stius", "Croa", "Medere"};
    ...
    private final static NumberFormat nfParser = NumberFormat.getInstance(Locale.CHINESE);
    ...
    public static final HashMap<String, Integer> GOTO_AREAS = new HashMap<String, Integer>() {{
        ...
        put("家族中心", 200000301);
        put("被遗忘的龙之巢穴", 240040511);
        put("射手村公园", 100000200);
        put("皮亚努斯洞穴", 230040420);
        put("暗黑龙王入口", 240050400);
        put("忘却的黄昏", 270050000);
        put("焰红森林堡垒", 610020006);
