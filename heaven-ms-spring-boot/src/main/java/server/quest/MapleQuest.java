...
public class MapleQuest {
    ...
    public boolean isSameDayRepeatable() {
        ...
        return ir.getInterval() < CommonConfig.config.server.questPointRepeatableInterval * 60 * 60 * 1000;
    }
    ...
    public boolean forceStart(MapleCharacter chr, int npc) {
        ...
        if (id / 100 == 35 && CommonConfig.config.server.totMobQuestRequirement > 0) {
            int setProg = 999 - Math.min(999, CommonConfig.config.server.totMobQuestRequirement);
